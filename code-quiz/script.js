$(document).ready(function (){
  ...
  function createInitialPage() {
      ...
      var header = $("<header><h1>Mini Coding Quiz! </h1></header>");
      var paragraph = $("<p>Try to answer the following code-related questions within the time limit. Incorrect answers will result in a penalty loss of time by ten seconds.</p>")
  ...
  function createLeaderboard() {
      ...
      if(highscores)
      {
          ...
          $.each(sortedHighscores, function(key, value)
          {
              ...
              if (counter % 2)
                  liElement.addClass("teal");
              else
                  liElement.addClass("slime");
